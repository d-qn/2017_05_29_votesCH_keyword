...
for(lang in colnames(txt)) {
  ...
  save_html(
    tags$html(
      tags$head(includeHTML(style_swi_highcharter()), includeCSS(shapes.path)),
      tags$h2(HTML(txt['main.title', lang])),
      div(class = "descr", HTML(paste0('<img src="https://interactive.swissinfo.ch/assets/Interactive_icon.svg.png" width="15" align="top">&nbsp; ', txt['descr', lang]))),
...
wc <- d3wordcloud(names(kwf), kwf, colors = sample(c(swi_col[-c(1, length(swi_col))], swi_pal[1:16]), length(kwf), T) , tooltip = T, padding = 1,
                  spiral = "rectangular", rotate.min = -30, rotate.max = 0, height=470,  font = "Open Sans")
